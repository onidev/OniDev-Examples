...
std::shared_ptr<Particle> Composite::addParticle(const od::Vec2 & pos)
{
    return addParticle(pos, od::Vec2(0, 0));
}

std::shared_ptr<Particle> Composite::addParticle(const od::Vec2 & pos, const od::Vec2 & vel)
{
